...
$(document).ready(function(){ 
	...
	var wikiResult = 
	"<div class='card'><div class='card-header'><h4 class='card-title info indigo'>위키백과</h4></div>"
	+"<div class='card-body'><div class='card-block'><div class='card-text'>"+
	"<div style='border: 1px solid #e2e2e2; width:100%;'>"
		...
		+ "<div class='div_text_mean'>"
			+ sent
		+ "</div>"
		+"<div style='width:100%' class='btn btn-primary'>단어 추가</div>"
		+ "</div>"
	+ "</div></div></div></div></div>";
