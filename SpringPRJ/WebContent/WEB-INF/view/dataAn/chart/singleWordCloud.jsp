...
// Themes begin
	...
	var chart = am4core.create("wordCloudView", am4plugins_wordCloud.WordCloud);
...
<div>단일 분석 워드클라우드 (단어를 클릭하면 의미를 알수 있습니다.)</div>
<div id="wordCloudView" style="width:100%;height: 300px"></div>
